...
;; Nem tente ler o código. Fiz esse jogo na velocidade da luz
;; e resultou que algumas funções estão ilegíveis e "pogada". Posso melhorar
;; o código futuramente, criar testes e documentar, mas só fiz mesmo pra brincar.
